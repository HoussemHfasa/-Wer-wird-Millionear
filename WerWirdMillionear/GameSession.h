...
public:
    ...
    void starteSpiel(const string& schwierigkeitsgrad, const string& kategorie);
    void beendeSpiel();
    void naechsteFrage();
    ...
    vector<Frage> vorbereiteteFragen(const string& schwierigkeitsgrad, const string& kategorie);
